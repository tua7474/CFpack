                ...
                {items.length === 0 ? (
                  ...
                  return orderedCats.flatMap(cat => {
                    ...
                    for (const modelName of orderedModels) {
                      ...
                      catRows.push(
                        <tr key={`model-${cat}-${modelName}`} className={cat === '2 มิล' ? 'bg-[#F7DC6F]' : cat === '4 มิล' ? 'bg-[#F0B27A]' : cat === '1.5 มิล' ? 'bg-[#F1948A]' : 'bg-gray-200'}>
                      ...
                      for (const item of modelItems) {
                        const rowBg = cat === '2 มิล' ? 'bg-[#FCF3CF]' : cat === '4 มิล' ? 'bg-[#FAE5D3]' : cat === '1.5 มิล' ? 'bg-[#FADBD8]' : (rowIdx % 2 === 0 ? 'bg-white' : 'bg-gray-50')
                        rowIdx++

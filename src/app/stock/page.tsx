...
const CATEGORY_MODELS: Record<string, string[]> = {
  '2 มิล':   ['สีอ่อน', 'พิเศษ A', 'พิเศษ B', 'ปุยนุ่น', 'โรมิโอ'],
  '4 มิล':   ['สีอ่อน', 'พิเศษ A', 'พิเศษ B', 'โรมิโอ'],
  '1.5 มิล': ['สีอ่อน', 'พิเศษ A', 'พิเศษ B', 'โรมิโอ'],
  'ฝอยหยัก': ['สีอ่อน', 'พิเศษ A', 'พิเศษ B', 'โรมิโอ'],
}
